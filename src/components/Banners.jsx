            ...
            <div className="row">
                <div className="col-md-6">
                    ...
                    <div className="banner-boton1">
                        <a className="boton1" href="https://www.tennis-warehouse.com/ApparelMen.html" target="_blank">Ver</a>
                    </div>
                </div>
                <div className="col-md-6">
                    ...
                    <div className="banner-boton2">
                        <a className="boton2" href="https://www.tennis-warehouse.com/TennisRacquets.html" target="_blank">Ver</a>
                    </div>
                    ...
                    <div className="banner-boton3">
                        <a className="boton3" href="https://www.tennis-warehouse.com/stringcontent.html" target="_blank">Ver</a>
                    </div>
                </div>
            </div>
